...
## Content found during the voice pass (needs Jonathan)
Found by the s33 drift reviews (repair/s33/review_*.md). The voice pass kept this text as it was; nothing below was changed.
- 2026-09-24 sellar-mass: prose (.dp, Defining criteria, Pertinents, Decoy note) says growth arrest at 11, Tanner 1 at 13, one year of headaches, height 50th to 5th, weight 75th; the vignette is 12 yo F, 6 months of morning headaches, height 75th to 10th, weight 60th. Pairs with calls the twin "a 13-year-old girl"; the twin's vignette is a 10 yo M.
- 2026-09-24 peds-headache-imaging: .dp and Distractors describe an adolescent girl with 2 years of unilateral headaches and menarche at 12 ("she"); the vignette is a 10 yo M with 1 year of bilateral headaches relieved by sleep. Pairs with says "same age and sex". Also its .rule keeps "No additional testing is rejected far more often because it feels too easy" (exam meta; the verifier will not let a voice op drop a sentence naming a test).
- 2026-09-24 bs-reye: the vignette box says the question asked for the most likely diagnosis (options Reye syndrome, acute viral hepatitis, bacterial meningitis); the subtitle, .dp and Option audit teach a question about the cause of the edema with five metabolic options.
- 2026-09-24 bs-posterior-fossa: "Every abnormal finding is on the left and every one is cerebellar" overstates; the left facial numbness (trigeminal) and papilledema are not cerebellar. Suggested: "Every cerebellar finding is on the left."
- 2026-09-24 redeye .rule: "Topical steroids are indicated in uveitis and scleritis"; scleritis needs systemic therapy (oral NSAIDs, then systemic steroids). Suggested: "anterior uveitis (topical) and scleritis (systemic)".
- 2026-09-24 hpv pearl: "In every vaccine series, do not restart and do not repeat" contradicts the bank item keyed "Repeat the second dose" (dose given before the minimum interval) and the .dp's "Minimum intervals matter".
- 2026-09-24 cervical: "ACS 2020 ... removes cytology-alone screening at ages 25–29 entirely"; ACS 2020 prefers primary HPV testing but still accepts cotesting or cytology alone where primary HPV testing is unavailable.
- 2026-09-24 bs-cervical-gate: "Cervical cancer under 21 is therefore rare" follows the screening-harm sentence; the rarity comes from clearance and slow progression. Also "HIV ... the one exception that starts screening before age 21" conflicts with the next row ("other immunocompromise, same accelerated schedule"); check the non-HIV start age against ACOG/ASCCP before editing.
- 2026-09-24 dipstick-mismatch Pairs with: "Drug-Induced Immune Hemolysis shares the finding of intravascular hemolysis with schistocytes"; that brief teaches hapten hemolysis as extravascular with spherocytes and a positive DAT, and says schistocytes with low platelets mean a clot.
- 2026-09-24 nephrotic-child Decision spine: steps "Read the last sentence", "The stem already said: membranous", "Which is on the option list?" are exam meta the voice ops did not touch.
- 2026-09-24 Verifier blocks three voice fixes (it refuses any op that drops a number or names a test in a dropped claim, with no exemption for workflow text): factor-inhibitor "The original miss was a 47-minute doubt loop..." (workflow text, still on the page); malform-syndromes label "Decision spine: solve the stem in 10 seconds"; the peds-headache-imaging "No additional testing" sentence above. Options: a verifier exemption for declared workflow text, or a non-voice edit.
